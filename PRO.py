...
def argsParser():
    ...
    arg_parse.add_argument("-v", "--video", default=None, help=r"C:\Users\naras\OneDrive\Desktop\MINPRO\s4.mp4")
    arg_parse.add_argument("-i", "--image", default=None, help=r"C:\Users\naras\OneDrive\Desktop\MINPRO")
    arg_parse.add_argument("-c", "--camera", default=False, help="true")
    arg_parse.add_argument("-o", "--output", type=str, help=r"C:\Users\naras\OneDrive\Desktop\MINPRO")
